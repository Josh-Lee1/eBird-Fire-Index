...
outputs<- bind_rows(habitat, food, size, sedentism, localonly)
outputs$test <- c("Habitat Specialism", "Food Specialism", "Body Size", "Sedentism", "Obligate Sedentism")
...
ggplot(modmobility, aes(localdisperse, Estimate*-1)) + geom_point()+ theme_bw() + xlab("Locally Dispersing") + ylab("Fire Response")
ggsave("Output/figures/mobilitymodel.PNG")
ggplot(modlocalonly, aes(localonly, Estimate*-1)) + geom_point() + theme_bw() + xlab("Obligate Sedentism") + ylab("Fire Response")
